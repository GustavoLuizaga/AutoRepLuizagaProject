...
This exception should be thrown when the data received or manipulated does not comply with the business rules or fundamental validations of the domain models.
"""
